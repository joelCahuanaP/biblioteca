...
<html>
<head>
 <title>Libros - Contabilidad</title>
...
<div class="recomendado">
 ...
 <?php 
  ...
  <div align="left" class="libro">
      ...
      <div class="libro-imagen">
	     <?php echo "<img class='port' src=".$row['Portada']. "alt='libro' />"?>
	      <!--<img src="../imagenes/libro-contabilidad1.png" alt="contabilidad"/>-->
      </div>	   
  ...
  <li class="articulo">
    <div align="left" class="libro">
      <div class="libro-imagen">
	      <img src="../imagenes/libro-contabilidad2.png" alt="contabilidad"/>
      </div>	   
	  <div class="libro-detalles">
	  
	      <h4>COSTOS EMPRESARIALES</h4></br>
          <p><b>Autor:</b> Carlos Augusto Rincon - Fernando Villareal Vasquez</p>
          <p><b>Edición:</b> Primera </p>
	      <p><b>Codigo:</b> 1b34</br></p>
		  <p><b>ISBN:</b> 978-958-648-616-3</p>
		  <p><b>Año:</b> 2006</p>
	      <a href="../libros-pdf/contabilidad/Costosempresariales.pdf" target="_blank"><font color=#873600 >Ver libro</font></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	      <a href="../recursos/reservar.php" target="_self">Reservar</a></br></br></br>
	  </div>
  </div>
  </li>
