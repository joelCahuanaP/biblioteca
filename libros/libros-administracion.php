...
<html>
<head>
 <title>Libros - Administracion</title>
 ...
 <aside class="repertorio">
  ...
  <div class="aside-contenedor">
      <div class="aside-filtros">
		  ...
		  <p><b>Autor</b></p>
		  <input id="buscador" type="text" name="tema"  placeholder="tema a filtrar"/>
      </div>
      <div class="aside-filtros">
	 </br><p><b>ISBN</b></p>
		  <input type="text" id="buscador" name="año1"  placeholder="Desde"/>
...
<div class="recomendado">
  ...
  <div align="left" class="libro">
	  ...
	  <?php echo "<img class='port' src=".$row['Portada']. "alt='libro' />"?>
	      ...
	      <!-- <img src="../imagenes/libro-administracion.png" alt="matematico"/> -->
      </div>	   
  ...
  <li class="articulo">
    <div align="left" class="libro">
	  ...
	  <div class="libro-detalles">
		  ...
		  <p><b>Año:</b> 2010</p>
	      <a href="../pdf/estadistica.pdf" target="_blank"><font color=#873600 >Ver libro</font></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
