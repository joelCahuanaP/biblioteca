...
<html>
<head>
 <title>Libros - Agroindustrial</title>
 ...
 <aside class="repertorio">
  ...
  <div class="aside-contenedor">
      <div class="aside-filtros">
		  ...
		  <p><b>Autor</b></p>
		  <input id="buscador" type="text" name="tema"  placeholder="Buscar"/>
      </div>
      <div class="aside-filtros">
	 </br><p><b>Editorial</b></p></br>
		  <input type="text" id="buscador" name="año1"  placeholder="Buscar"/>-
...
<div class="recomendado">
  ...
  <div align="left" class="libro">
	  ...
	  <?php echo "<img class='port' src=".$row['Portada']. "alt='libro' />"?>
	    <!--  <img src="../imagenes/libro-agroindustrial.png" alt="matematico"/> -->
      </div>	   
  ...
  <li class="articulo">
    <div align="left" class="libro">
	  ...
	  <div class="libro-detalles">
		  ...
		  <p><b>Año:</b> 2004</p>
	      <a href="https://www.fao.org/3/i3125s/i3125s.pdf" target="_blank"><font color=#873600 >Ver libro</font></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	      <a href="../recursos/reservar.php" target="_self">Reservar</a></br></br></br>
	  </div>
  </div>
  </li>
