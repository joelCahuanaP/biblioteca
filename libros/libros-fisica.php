 ...
 <aside class="repertorio">
  ...
  <div class="aside-contenedor">
      <div class="aside-filtros">
		  ...
		  <p><b>Autores</b></p>
		  <input id="buscador" type="text" name="tema"  placeholder="Autores"/>
      </div>
      <div class="aside-filtros">
	 </br><p><b>Editorial</b></p>
		  <input id="buscador" type="text" name="año1"  placeholder="Editorial"/>-
...
<div class="recomendado">
  ...
  <div align="left" class="libro">
      <div class="libro-imagen">
	      ...
	      <!-- <img src="../imagenes/libro-fisica.png" alt="fisica"/>-->
      </div>	   
	  <div class="libro-detalles">
	      ...
	      <p><b>Codigo:</b> </b><?php echo $row['ID_LIBRO']?></p>
  ...
  <li class="articulo">
    <div align="left" class="libro">
      <div class="libro-imagen">
	      <img src="../imagenes/libro-fisica2.png" alt="fisica"/>
      </div>	   
	  <div class="libro-detalles">
	  
	      <h4>ESTATICA APLICADA</h4></br>
          <p><b>Autor:</b>RAUL SALVADOR LLANO</p>
          <p><b>Edición:</b> Primera </p>
	      <p><b>Codigo:</b> 1b34</p>
		  <p><b>ISBN:</b> 950-39-0115-4</p>
		  <p><b>Año:</b> 2010</p>
	      <a href="https://bdigital.uncuyo.edu.ar/objetos_digitales/11832/llano.pdf" target="_blank"><font color=#873600 >Ver libro</font></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	      <a href="../recursos/reservar.php" target="_self">Reservar</a></br></br></br>
	  </div>
  </div>
  </li>
  ...
  <li class="articulo">
    <div align="left" class="libro">
      <div class="libro-imagen">
	      <img src="../imagenes/libro-fisica.png" alt="probabilidad" />
      </div>	   
	  <div class="libro-detalles">
	  
	      <h4>FÍSICA</h4></br>
          <p><b>Autor:</b> José Ricardo Luna Victoria Muñoz</p>
          <p><b>Edición:</b> primera</p>
	      <p><b>Codigo:</b> 1b44</p>
		  <p><b>Año:</b> 2009</p>
	      <a href="https://itscv.edu.ec/wp-content/uploads/2018/10/FISICA-BASICA-UNIVERSIDAD-RICARDO-PALMA.pdf" target="_blank"><font color=#873600 >Ver libro</font></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	      <a href="../recursos/reservar.php" target="_self">Reservar</a></br></br></br>
	  </div>
  </div>
  </li>
