<?php 
 ...
 include("../conexion/conexion.php");
   ...
   $consulta= "SELECT * FROM externo
            ...
            WHERE ID_Externo=".$_REQUEST["idus"]."				
			";
...
<div class="actuLibro">
    <div class="content">
            <br>
            <h1 class="logo"><span>A</span>ctualizar <span>U</span>suario - Externo</h1>
            <br>

            
                <div class="contact-form">
                    
                    <form action="updateExterno.php" method="post" >
                       
						    <input readonly type="hidden" name="idExterno" placeholder="Id Alumno" value="<?php if(isset($con['ID'])): echo $con['ID']; endif; ?>">
						...
						<div class="campo">
                            ...
                            <input type="text" name="universidad" placeholder="Universidad" value="<?php if(isset($con['Universidad'])): echo $con['Universidad']; endif; ?>">
                        </div>
						<div class="campo">
                       ...
                       <div class="campo">
						...
						<div class="campo">
						    <label>DNI</label></br> 
						    <input readonly type="text" name="dni" placeholder="DNI" value="<?php if(isset($con['DNI'])): echo $con['DNI']; endif; ?>">					
						</div>					
                        <div class="campo">
