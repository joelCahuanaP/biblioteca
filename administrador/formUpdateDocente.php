 ...
 include("../conexion/conexion.php");
  ...
  session_start();
   ...
   $consulta= "SELECT * FROM docente
            ...
            WHERE ID_Docente=".$_REQUEST["idus"]."				
			";
	     ...
	     <ul class="nav">
			...
			<li><a href="">Usuarios</a>
			    <ul>
					...
					<li><a href="../nosotros/reseña.php">Docentes</a></li>
					<li><a href="../nosotros/himno.php">Externos</a></li>			
				</ul></li>
...
<div class="actuLibro">
    <div class="content">
            <br>
            <h1 class="logo"><span>A</span>ctualizar <span>U</span>suario - Docente</h1>
            <br>
                ...
                <div class="contact-form">
                    ...
                    <form action="UpdateDocente.php" method="post" >
						...
						<div class="campo">
						    <label>ID</label></br> 
						    <input readonly type="text" name="idDocente" placeholder="Id Docente" value="<?php if(isset($con['ID'])): echo $con['ID']; endif; ?>">
