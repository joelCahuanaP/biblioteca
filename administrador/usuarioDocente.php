...
<div class="contenedor1 opciones">
   ...
   <div>
      <a href="formInsertarDocente.php" ><button id="bus" name="button" class="btn btncolor">Añadir Usuario</button></a>
   </div>
</div>
...
<div class="cont-libro">
    ...
    <center><div class="tit">
       <h2>REGISTRO USUARIOS - DOCENTES </h2>
  </div></center>
    <table>
	     <thead>
		    <tr>
		 ...
		 <tbody>
		    ...
		    <tr>
				...
				<td><?php echo "<a class='controles' href='formUpdateDocente.php?idDocente=".$row["ID"]."&idus=".$row["ID_Docente"]."'>Editar</a>" ?></td>
				<td><?php echo "<a class='controles' href='eliminarDocente.php?idDocente=".$row["ID"]."'>Eliminar</a>" ?></td>
				
			</tr>
			  <?php }}else{ include("buscarDocente.php");
            ...
            <tr>
				...
				<td><?php echo $row['Contraseña']?></td>
				<td><?php echo $row['Telefono']?></td>
				<td><?php echo "<a class='controles' href='formUpdateDocente.php?idDocente=".$row["ID"]."'>Editar</a>" ?></td>
				<td><?php echo "<a class='controles' href='eliminarDocente.php?idDocente=".$row["ID"]."'>Eliminar</a>" ?></td>
