<?php 
 ...
 include("../conexion/conexion.php");
  ...
  if(isset($_SESSION['tex'])){
   ...
   $tablaautor=mysqli_query($conexion,$consulta);
   
   $consulta2="SELECT * FROM area";
   $tablaarea=mysqli_query($conexion,$consulta2);
   
   $consulta3="SELECT * FROM editorial";
   $tablaedi=mysqli_query($conexion,$consulta3);
...
<div class="actuLibro">
    <div class="content">
           <br>
            <h1 class="logo"><span>A</span>ñadir <span>L</span>ibro</h1>
            <br>
                       ...
                       <div class="campo">
                        ...
                        <div class="campo">
						 ...
						 <div class="campo">
                            ...
                            <input  type="text" name="rulibro" placeholder="Ruta Libro" >
                        </div>
						 <div class="campo">
                            <label>ISBN</label>
                            <input id="list" type="text" name="isbn" placeholder="ISBN">
                        </div>
