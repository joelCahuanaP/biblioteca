...
<div class="contenedor1 opciones">
   ...
   <div>
      <a href="formInsertarAlum.php" ><button id="bus" name="button" class="btn btncolor">Añadir Usuario</button></a>
   </div>
</div>

<div class="cont-libro">
  <center><div class="tit">
       <h2>REGISTRO USUARIOS - ALUMNOS </h2>
  </div></center>
    <table>
	     <thead>
		    <tr>
		 ...
		 <tbody>
		    ...
		    <tr>
				...
				<td><?php echo "<a class='controles' href='formUpdateAlum.php?idAlum=".$row["ID"]."&idus=".$row["ID_Alumno"]."'>Editar</a>" ?></td>
				<td><?php echo "<a class='controles' href='eliminarAlum.php?idAlum=".$row["ID"]."'>Eliminar</a>" ?></td>
				
			</tr>
			  <?php }}else{ include("buscarAlum.php");
